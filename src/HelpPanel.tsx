    ...
    },
    {
      ...
      body: (
        <p>
          ...
          Hand-written {`{++insertions++}`} and {`{--deletions--}`} are
          suggestions too. All live in the markdown itself (CriticMarkup), so
          they version and merge like any edit. <kbd>⌘⇧J</kbd> cycles through
